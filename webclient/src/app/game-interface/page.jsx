...
export default function GameInterface() {
  ...
  return (
    <div className="flex gap-2 p-4 h-screen bg-mainbg text-xs">
      {/* First Column */}
      <div className="flex shrink flex-col gap-2">
        ...
        <GameTile title="Windows" className="">
          <ul className="">
            <li>
              <button 
      ...
      {/* Second Column */}
      <div className="flex flex-col gap-2 flex-grow h-full min-h-0">
        {/* Top Row */}
        <div className="flex gap-2">
          {/* Character Information Tile */}
          <GameTile title="Character" className="w-1/3">
            <div>
          ...
          {/* Locations Tile */}
          <GameTile title="Locations" className="w-1/3 shrink">
          ...
          {/* Activity Tile */}
          <GameTile title="Activity" className="w-1/3 shrink">
            <div className="flex items-center justify-center h-full">
              <button className="px-6 py-3 bg-button text-white rounded-lg hover:bg-buttonhover transition-colors">
                Start Activity
              </button>
            </div>
          </GameTile>
